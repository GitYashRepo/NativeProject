    ...
    const loadData = async () => {
        try {
            ...
            const transformedCategories = apiCategories.map((cat, index) => ({
                ...
                (cat) =>
                    !["beef", "lamb", "pork"].includes(cat.name.toLowerCase())
            );
            ...
            if (
                transformedFeatured &&
                !["beef", "lamb", "pork"].includes(transformedFeatured.category?.toLowerCase())
            ) {
                setFeaturedRecipe(transformedFeatured);
            } else {
                setFeaturedRecipe(null); // no featured if it belongs to blocked categories
            }
        } catch (error) {
