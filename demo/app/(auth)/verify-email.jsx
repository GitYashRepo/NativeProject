...
const VerifyEmail = ({ email, onBack }) => {
    ...
    const handleVerification = async () => {
        ...
        try {
            ...
            } else if (signUpAttempt.status === "needs_identifier") {
                Alert.alert("Error", "Missing email/identifier");
            } else {
            ...
            if (code === "verification_already_verified") {
                console.warn("Already verified → activating session...");
            ...
            if (code === "form_identifier_not_found") {
                Alert.alert("Error", "We couldn’t find your sign-up. Please try signing up again.");
                onBack();
                return;
            }
